...
export async function POST(request) {
  ...
  try {
    ...
    const transporter = nodemailer.createTransport({
      host: "mail.angelicauniforms.com.au", // SiteGround SMTP server
      port: 465, // Use 465 for SSL
      secure: true, // true for SSL
      auth: {
        user: "support@angelicauniforms.com.au", // Your email address on the SiteGround server
    ...
    // Email options
    const mailOptions = {
      from: "support@angelicauniforms.com.au", // Use your SiteGround-hosted email address
      replyTo: email, // Set the reply-to to the user's email address
      to: "support@angelicauniforms.com.au", // Your receiving email address
